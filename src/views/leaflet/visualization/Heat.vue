...
function addHeatmap() {
	...
	for (let i = 0; i < 2000; i++) {
		let zby = 24.44 + Math.random() * 0.1
		let zbx = 118.08 + Math.random() * 0.1
		let value = Math.floor(Math.random() * 100)
		heatPoints.push([zby, zbx, value])
	}
	for (let i = 0; i < 100; i++) {
		let zby = 24.45 + Math.random() * 0.01
		let zbx = 118.08 + Math.random() * 0.01
		let value = Math.floor(Math.random() * 100)
		heatPoints.push([zby, zbx, value])
	}
	for (let i = 0; i < 300; i++) {
		let zby = 24.47 + Math.random() * 0.02
		let zbx = 118.12 + Math.random() * 0.02
		let value = Math.floor(Math.random() * 100)
		heatPoints.push([zby, zbx, value])
	}
	...
	map.addLayer((L as any).heatLayer(heatPoints, option))
